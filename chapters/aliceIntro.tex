...
They were all hungry by now though, and Nate promised to email Alice the pictures he had taken of the chalkboard as they worked through the integrals in the other room. "Thanks Nate."

\mymark

%Physicists in a grouop are incapible of making decisions. Big decisions, yes, or maybe sometimes, but trivial decisions like where to go for dinner, no. It's probably some combination of shyness and their willingness to accept that they genuinely weren't sure what they wanted, thought Alice, too many variables but still worth figuring out. Or maybe they're just used to there always being someone else with a stronger opinion than their own to lead the pack. Either way, she had seen it happen before where they had decided to go for dinner and then spent then next forty five minutes in the hallway outside their offices. 
%
%They ended up at Doty's, at Alice's suggestion, which had good hamburgers and great cheese curds, a midwestern delacacy that was new to Alice when she first arrived in Madison. The closest thing they have in Pennslyvania are maybe mozzarella sticks, battered and deep fried cheese, but instead of mozzarella, these were unpressed cheddar curds that came with a variety of sauces, golden brown, hot, and covered your fingers with grease. They also had a good collection of beers on tap, another thing Alice had quickly learned Madison is known for, 
