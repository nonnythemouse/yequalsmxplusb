...
\null
% \null\vspace{35pt}
% {\Huge\sffamily\itshape y=mx+b }
% \vspace{35pt}
% \\
% T. Perry

\ThisCenterWallPaper{1}{cover.png} % Add the background image, the first argument is the scaling - adjust this as necessary so the image fits the entire page
%
