...
\usepackage[vcentermath]{youngtab} % young tableaux (vertical centering)
\usepackage{amsmath} % align environment, and well, this is a math book
...
\makeoddhead{mio}{\scriptsize{\theauthor\hskip.2cm\vrule\hskip.2cm\sffamily\itshape{\thetitle}}}{}{} % Header specification
...
\renewcommand{\chapterheadstart}{\null } % Whitespace before the chapter starts
%\renewcommand{\chapterheadstart}{\null \onelineskip} % Whitespace before the chapter starts
%\renewcommand{\chapterheadstart}{\null \vskip1.5\onelineskip} % Whitespace before the chapter starts
\renewcommand{\printchaptername}{\large\itshape\chaptername} % "Chapter" text font specification
\renewcommand{\printchapternum}{\large thechapter \\} % Chapter number font specification
...
%\makechapterstyle{Rufte}{ % Define a new chapter style
%}
